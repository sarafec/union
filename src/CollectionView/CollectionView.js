		...
		<div className="collection-container" key={index}>
			<div className="collection-photo-viewer">
				<div className="collection-photo-background">
					<img className="collection-photo" src={collection.photos[this.state.currentPhoto].substring(1)} alt="fashionable person" onClick={this.pushPhotoForward} onKeyDown={this.decipherKeyDown} tabIndex="2" />
